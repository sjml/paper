...
complete -c paper -n "__fish_use_subcommand" -s h -l help -d 'Print help'
...
complete -c paper -n "__fish_seen_subcommand_from new" -s h -l help -d 'Print help'
complete -c paper -n "__fish_seen_subcommand_from init" -s v -l verbose -d 'Spam the output log'
complete -c paper -n "__fish_seen_subcommand_from init" -s h -l help -d 'Print help'
complete -c paper -n "__fish_seen_subcommand_from dev" -s v -l verbose -d 'Spam the output log'
complete -c paper -n "__fish_seen_subcommand_from dev" -s h -l help -d 'Print help'
...
complete -c paper -n "__fish_seen_subcommand_from push" -s h -l help -d 'Print help'
complete -c paper -n "__fish_seen_subcommand_from web" -s v -l verbose -d 'Spam the output log'
complete -c paper -n "__fish_seen_subcommand_from web" -s h -l help -d 'Print help'
...
complete -c paper -n "__fish_seen_subcommand_from wc" -s h -l help -d 'Print help'
...
complete -c paper -n "__fish_seen_subcommand_from watch" -s h -l help -d 'Print help'
...
complete -c paper -n "__fish_seen_subcommand_from fmt" -s h -l help -d 'Print help'
